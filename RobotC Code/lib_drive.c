...
/**********************/
//S Turn Using Encoders
/**********************/
//void separateMotorDriveEnc(short LPower, short RPower, short timeOut, int lEncoder, int rEncoder) {
...
//	CTimer T = getFreeTimer();
//	driveMotors(LPower, RPower);
//	while ((time(T) <  timeOut) /*&& (motor[leftDrive] != 0 || motor[rightDrive] != 0)*/ && (encoderLessThanTargetABS(leftDrive, lEncoder) || encoderLessThanTargetABS(rightDrive, rEncoder))) {
//		if (!encoderLessThanTargetABS(leftDrive, lEncoder))
//			motor[leftDrive] = 0;
//		if (!encoderLessThanTargetABS(rightDrive, rEncoder))
//			motor[rightDrive] = 0;
//		wait1Msec(10);
//	}
//	freeTimer(T);
...
////S Turn Using Encoders
///**********************/
//void separateMotorDriveBackEnc(short LPower, short RPower, short timeOut, int lEncoder, int rEncoder) {
...
//	CTimer T = getFreeTimer();
//	driveMotors(LPower, RPower);
//	while ((time(T) <  timeOut) /*&& (motor[leftDrive] != 0 || motor[rightDrive] != 0)*/ && (encoderGreaterThanTargetABS(leftDrive, lEncoder) || encoderGreaterThanTargetABS(rightDrive, rEncoder))) {
//		if (!encoderGreaterThanTargetABS(leftDrive, lEncoder))
//			motor[leftDrive] = 0;
//		if (!encoderGreaterThanTargetABS(rightDrive, rEncoder))
//			motor[rightDrive] = 0;
//		wait1Msec(10);
//	}
//	freeTimer(T);
...
//S Turn Using Encoders
///**********************/
//void separateMotorDriveEncBack(short LPower, short RPower, short timeOut, int lEncoder, int rEncoder) {
...
//	CTimer T = getFreeTimer();
//	driveMotors(LPower, RPower);
//	while ((time(T) <  timeOut) && (motor[leftDrive] != 0 || motor[rightDrive] != 0) &&(encoderGreaterThanTarget(leftDrive, lEncoder) || encoderGreaterThanTarget(rightDrive, rEncoder))) {
//		if (!encoderGreaterThanTarget(leftDrive, lEncoder))
//			 motor[leftDrive] = 0;
//		if (!encoderGreaterThanTarget(rightDrive, rEncoder))
//			 motor[rightDrive] = 0;
//		wait1Msec(10);
//	}
//	freeTimer(T);
...
//void driveStopLeftMotors(){
//	motor[leftDrive] = 0;
//}

//void driveStopRightMotors(){
//	motor[rightDrive] = 0;
//}
